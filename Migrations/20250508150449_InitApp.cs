    ...
    public partial class InitApp : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentPositions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecruitmentRequirements_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecruitmentRequirements_RecruitmentPositions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "RecruitmentPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPosts_Employees_PostedById",
                        column: x => x.PostedById,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPosts_RecruitmentRequirements_RequirementId",
                        column: x => x.RequirementId,
                        principalTable: "RecruitmentRequirements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPosts_RequirementId",
                table: "JobPosts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentRequirements_EmployeeId",
                table: "RecruitmentRequirements",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentRequirements_PositionId",
                table: "RecruitmentRequirements",
                column: "PositionId");
        }
